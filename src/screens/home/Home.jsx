...
const Home = ({ navigation }) => {
  ...
  const [umidity, setUmidity] = useState(30);
  ...
  const backgroundUmidity = () => {
    ...
    switch (true) {
      case numericUmidity >= 10 && numericUmidity <= 40:
        return require('../../assets/home-screen/umidity20.json');
      case numericUmidity >= 40 && numericUmidity <= 60:
        return require('../../assets/home-screen/umidity40.json');
      case numericUmidity >= 60 && numericUmidity <= 80:
        return require('../../assets/home-screen/umidity60.json');
      case numericUmidity >= 80 && numericUmidity <= 100:
        return require('../../assets/home-screen/umidity80.json');
      default:
        return require('../../assets/home-screen/umidityDefault.json');
    }
  };
  ...
  const iconUmidity = () => {
    ...
    switch (true) {
      case numericUmidity >= 10 && numericUmidity <= 40:
        return require('../../assets/home-screen/desert.json');
      case numericUmidity >= 40 && numericUmidity <= 60:
        return require('../../assets/home-screen/umidity40logo.json');
      case numericUmidity >= 60 && numericUmidity <= 80:
        return require('../../assets/home-screen/umidity60logo.json');
      case numericUmidity >= 80 && numericUmidity <= 100:
        return require('../../assets/home-screen/umidity80logo.json');
      default:
        return require('../../assets/home-screen/umidityLoading.json');
    }
  };
    ...
    switch (true) {
      ...
      default:
        return [
          {
            id: '1',
            text: 'Procurando umidade...',
            subtitle: 'Certifique de configurar seu sensor',
          },
        ];
    }
  };
    ...
    <View className="flex-1 justify-center items-center">
      ...
      <View className="absolute min-h-full top-14 left-3">
        <View className="flex flex-row items-center space-x-2">
          ...
          <Text className="text-base text-white">Bem vindo, {user.name}</Text>
        </View>
      </View>
      <View className="flex flex-row items-center justify-between min-w-full pl-12 pr-5">
        ...
        <LottieView source={iconUmidity()} style={{ width: '70%', height: '150%' }} autoPlay loop />
      </View>

      <View
        style={{ width: windowWidth * 0.8, height: 40, display: 'flex', flexDirecrtion: 'row' }}
      >
        <Text className="text-white text-lg">
          Temp. do ambiente: <Text className="font-black">{temperature}° </Text>
        </Text>
      </View>
        ...
        >
          <LinearGradient
            ...
            style={{
              ...
              borderRadius: 15,
              overflow: 'hidden',
            }} // Ajusta o tamanho da nova seção
          >
            <ImageBackground
              source={require('../../assets/noise.png')}
              resizeMode="cover"
      ...
      {/* Menu */}
      <View
        className="w-72 h-16 absolute bottom-4 rounded-3xl flex justify-center items-center"
      ...
      >
        <View className="flex flex-row space-x-6">
          <IconButton
            ...
            onPress={() => navigation.navigate('PrincipalTabs', { screen: 'Principal' })}
          />
          <IconButton
            icon="cloud"
            iconColor={MD3Colors.primary100}
            onPress={() => navigation.navigate('PrincipalTabs', { screen: 'PrincipalWeather' })}
          />
